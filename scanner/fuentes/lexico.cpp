...
char *lexpal[MAXPAL] = { "and", "array", "average", "bool", "break", "case", "char", "closeFile", "compare", "concat", "else", "even", 
						"exist", "factorial", "false", "file", "float", "for", "function", "if", "int", "main", "null", "openFile", "or", 
						"pow", "print", "procedure", "read", "ref", "repeat", "return", "sort", "string", "substring", "switch", "true", 
						"until", "while"};
...
enum simbolo tokpal[MAXPAL] = { andTok, arrayTok, averageTok, boolTok, breakTok, caseTok, charTok, closeFileTok, compareTok, concatTok, elseTok, 
								...
								substringTok, switchTok, trueTok, untilTok, whileTok };
