...
char *lexpal[MAXPAL] = { "and", "array", "average", "bool", "break", "case", "char", "closeFile", "compare", "concat", "cond", "do", "else",
...
enum simbolo tokpal[MAXPAL] = { andTok, arrayTok, averageTok, boolTok, breakTok, caseTok, charTok, closeFileTok, compareTok, concatTok, condTok, doTok,
								elseTok, evenTok, factorialTok, falseTok, fileTok, floatTok, forTok, functionTok, ifTok, intTok, mainTok,
